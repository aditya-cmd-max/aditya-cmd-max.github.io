...
class ReverbitAuth {
    ...
    createDesktopAvatar() {
        ...
        // Find header actions container or desktop nav
        ...
        // Insert into desktop nav (before sign in button or theme toggle)
    ...
    async handleAvatarUpload() {
        if (!this.user || !this.avatarUploadInput) {
